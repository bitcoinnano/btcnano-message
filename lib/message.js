...
Message.MAGIC_BYTES = new Buffer('Btcnano Signed Message:\n');
...
/**
 * Will sign a message with a given btcnano private key.
 *
...
/**
 * Will return a boolean of the signature is valid for a given btcnano address.
 * If it isn't the specific reason is accessible via the "error" member.
 *
 * @param {Address|String} bitcoinAddress - A btcnano address
